...
const CloudLightningS = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g clipPath="url(#prefix__clip0)" fill="currentColor">
      ...
      <path d="M11 24c-.2 0-.4-.1-.6-.2-.5-.3-.6-.9-.3-1.4l3-4.4H9c-.4 0-.7-.2-.9-.5-.2-.3-.2-.7 0-1l4-6c.3-.5.9-.6 1.4-.3.5.3.6.9.3 1.4l-3 4.4H15c.4 0 .7.2.9.5.2.3.2.7 0 1l-4 6c-.3.3-.6.5-.9.5z" />
    </g>
    <defs>
...
export default CloudLightningS;
